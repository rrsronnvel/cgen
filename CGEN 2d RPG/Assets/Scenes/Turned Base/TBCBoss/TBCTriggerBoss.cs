...
public class TBCTriggerBoss : MonoBehaviour, IDataPersistence, Interactable
{
    ...
    public void OnEnterButton()
    {
        ...
        // Store the ID of the TBCTriggerBoss and the name of the current scene
        if (DataPersistenceManager.instance != null)
        {
            ...
            if (gameData != null)
            {
                ...
                gameData.activeTBC = id; // Store the ID of the TBCTriggerBoss
            }
